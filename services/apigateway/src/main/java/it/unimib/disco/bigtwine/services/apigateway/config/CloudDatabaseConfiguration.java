...
@Configuration
@EnableMongoRepositories("it.unimib.disco.bigtwine.services.apigateway.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("it.unimib.disco.bigtwine.services.apigateway.config.dbmigrations");
