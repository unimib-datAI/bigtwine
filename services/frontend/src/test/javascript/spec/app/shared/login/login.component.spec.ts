...
import { BtwLoginModalComponent } from 'app/shared/login/login.component';
...
describe('Component Tests', () => {
    describe('LoginComponent', () => {
        let comp: BtwLoginModalComponent;
        let fixture: ComponentFixture<BtwLoginModalComponent>;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [BtwLoginModalComponent],
                providers: [
                    {
                ...
                .overrideTemplate(BtwLoginModalComponent, '')
                .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(BtwLoginModalComponent);
